    ...
    <div style={styles.page}>
      ...
      <div style={styles.left}>
        <div style={styles.leftInner}>
          ...
          <p style={styles.heroSub}>Point-of-Sale &amp; Inventory Management</p>
          <div style={styles.features}>
            {['Real-time inventory tracking', 'Multi-role access control', 'Sales &amp; return management', 'Customer credit accounts'].map(f => (
        ...
        <p style={styles.leftFooter}>StockFlow v1.0</p>
      </div>
