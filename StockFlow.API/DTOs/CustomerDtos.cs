...
public record CustomerTransactionItemDto(string ProductName, string Barcode, decimal Quantity, decimal UnitPrice, decimal Total);
...
public record CustomerPurchaseCheckDto(bool Purchased, decimal? LastPrice);
